...
if($action==='send-direct'){
  $mail=array('to'=>isset($body['to'])?trim((string)$body['to']):'','subject'=>cut(clean_line(isset($body['subject'])?$body['subject']:''),250),'message'=>trim(isset($body['message'])?(string)$body['message']:''));
