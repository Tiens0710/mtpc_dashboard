...
function mtpc_has_permission($permission){global $mtpcActor;$map=array('admin'=>array('*'),'training'=>array('students.read','students.write','academic.read','academic.write','attendance.read','attendance.write','finance.read','audit.read','moodle.read','moodle.write','moodle.content.write','moodle.assignment.write','moodle.grade.write','moodle.group.write','moodle.calendar.write','moodle.message.write'),'teacher'=>array('students.read','academic.read','attendance.read','attendance.write','moodle.read','moodle.content.write','moodle.assignment.write','moodle.grade.write','moodle.group.write','moodle.calendar.write','moodle.message.write'));$allowed=isset($map[$mtpcActor['role']])?$map[$mtpcActor['role']]:array();return in_array('*',$allowed,true)||in_array($permission,$allowed,true);}
