...
function mtpc_has_permission($permission){global $mtpcActor;$map=array('admin'=>array('*'),'training'=>array('students.read','students.write','academic.read','academic.write','attendance.read','attendance.write','finance.read','audit.read'),'teacher'=>array('students.read','academic.read','attendance.read','attendance.write'));$allowed=isset($map[$mtpcActor['role']])?$map[$mtpcActor['role']]:array();return in_array('*',$allowed,true)||in_array($permission,$allowed,true);}
