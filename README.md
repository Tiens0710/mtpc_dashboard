...
Sau khi cấu hình, Zalo OA có thể tự trả lời 1:1 bằng `gemini-3.1-flash-lite` với tư cách Trường Trung cấp Miền Tây. Trên dashboard web, Nhi vẫn dùng Gemini Live; lệnh “đọc tin nhắn Zalo hôm nay” sẽ đọc các tin đã lưu trong ngày.
